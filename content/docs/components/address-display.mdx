...
By default, explorer links point to Etherscan. Pass `explorerUrl` for Base, Optimism, Arbitrum, or any other EVM chain explorer.

## Examples

### With Base Explorer

Pass `explorerUrl` to link to any chain's explorer.
