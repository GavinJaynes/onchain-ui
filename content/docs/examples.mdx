...
```bash
npx shadcn add card https://onchain-ui.dev/r/asset-row https://onchain-ui.dev/r/token-price
```
...
```bash
npx shadcn add card https://onchain-ui.dev/r/address-identity https://onchain-ui.dev/r/token-balance
```
...
```bash
npx shadcn add card badge https://onchain-ui.dev/r/token-stack https://onchain-ui.dev/r/token-price
```
